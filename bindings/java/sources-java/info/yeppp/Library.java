...
public class Library {
	 ...
	 *
	 * @return	A {@link CpuVendor} object with information about the company which designed the CPU core.
	 *
	 * @see	CpuVendor
	 */
	 ...
	 *
	 * @return	A {@link CpuArchitecture} instance with information about the architecture of the CPU.
	 *
	 * @see	CpuArchitecture
	 */
	 ...
	 *
	 * @return	A {@link CpuMicroarchitecture} instance with information about the microarchitecture of the CPU core.
	 *
	 ...
	 * <p>
	 * Call {@link Library#releaseCycleCounter Library.releaseCycleCounter} to get the number of processor cycles passed.
	 *
	 * @warning	This function may allocate system resources.
	 *         	To avoid resource leak, always match a successfull call to {@link #acquireCycleCounter acquireCycleCounter} with a call to {@link #releaseCycleCounter releaseCycleCounter}.
	 ...
	 *
	 * @return	An object representing the state of the processor cycle counter. Pass this object to {@link #releaseCycleCounter releaseCycleCounter} to get the number of cycles passed.
	 *
	 ...
	 *
	 * @param	cycleCounter	An object representing the state of the cycle counter returned by {@link #acquireCycleCounter acquireCycleCounter}.
	 *       	            	The cycle counter should be released only once, and this function invalidates the object.
	 *
	 * @return	The number of cycles elapsed since the call to {@link #acquireCycleCounter acquireCycleCounter}.
	 *        	This value should be interpreted as unsigned 64-bit integer.
	 *
	 ...
	 *
	 * @param	isaFeature	An object specifying the ISA extension of interest.
	 *
	 * @return	true if the processor supports the specified ISA extension and false otherwise.
	 *
	 * @see	CpuIsaFeature
	 ...
	 *
	 * @param	simdFeature	An object specifying the SIMD extension of interest.
	 *
	 * @return	true if the processor supports the specified SIMD extension and false otherwise.
	 *
	 * @see	CpuSimdFeature
	 ...
	 *
	 * @param	systemFeature	An object specifying the non-ISA processor or system feature of interest.
	 *
	 * @return	true if the specified processor or system extension is supported on this machine and false otherwise.
	 *
	 * @see	CpuSystemFeature
