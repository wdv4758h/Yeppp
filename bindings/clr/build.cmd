...
rc /I../../library/headers /Fobinaries/Version.res sources/Version.rc

%CSC% %CSCFLAGS% /out:binaries/yeppp-clr.dll /win32res:binaries/Version.res sources\Library.cs sources\Math.cs sources\Core.cs
