...
namespace Yeppp
{
	...
	public sealed class MipsCpuSimdFeature : CpuSimdFeature
	{
		...
		public static readonly MipsCpuSimdFeature MIPS3D       = new MipsCpuSimdFeature(1);
		/// <summary>Paired-single instructions.</summary>
		public static readonly MipsCpuSimdFeature PairedSingle = new MipsCpuSimdFeature(2);
		...
		public static readonly MipsCpuSimdFeature IMX          = new MipsCpuSimdFeature(6);
