...
SET(YEPPP_TARGET_NAME "android-armeabi")
...
SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -marm -march=armv5te -mtune=arm1136j-s -mfloat-abi=soft")
...
# Target-specific options
SET(CMAKE_ASM_FLAGS "-I${CMAKE_SOURCE_DIR}/sources/arm -march=armv5te")
# Code-generation options
