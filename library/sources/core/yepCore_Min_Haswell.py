...
#         YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V8sV8s_V8s:
#     binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
#         (arg_x, arg_y, arg_z, arg_n),
#         YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V8uV8u_V8u:
#     binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V16sV16s_V16s",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V16sV16s_V16s:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V16uV16u_V16u",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V16uV16u_V16u:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V32sV32s_V32s",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V32sV32s_V32s:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V32uV32u_V32u",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V32uV32u_V32u:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V32fV32f_V32f",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V32fV32f_V32f:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
...
with Function("yepCore_Min_V64fV64f_V64f",
        (arg_x, arg_y, arg_z, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as yepCore_Min_V64fV64f_V64f:
    binop_VV_V(arg_x, arg_y, arg_z, arg_n, "min", "AVX2")
