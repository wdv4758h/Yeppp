...
with Function("yepCore_Subtract_IV8sS8s_IV8s",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV8sS8s_IV8s:
...
with Function("yepCore_Subtract_IV16sS16s_IV16s",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV16sS16s_IV16s:
    binop_IVS_IV(arg_x, arg_y, arg_n, "subtract", "AVX2")
...
with Function("yepCore_Subtract_IV32sS32s_IV32s",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV32sS32s_IV32s:
    binop_IVS_IV(arg_x, arg_y, arg_n, "subtract", "AVX2")
...
with Function("yepCore_Subtract_IV64sS64s_IV64s",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV64sS64s_IV64s:
    binop_IVS_IV(arg_x, arg_y, arg_n, "subtract", "AVX2")
...
with Function("yepCore_Subtract_IV32fS32f_IV32f",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV32fS32f_IV32f:
    binop_IVS_IV(arg_x, arg_y, arg_n, "subtract", "AVX2")
...
with Function("yepCore_Subtract_IV64fS64f_IV64f",
        (arg_x, arg_y, arg_n),
        YepStatus, target=uarch.haswell + isa.avx2) as Subtract_IV64fS64f_IV64f:
    binop_IVS_IV(arg_x, arg_y, arg_n, "subtract", "AVX2")
