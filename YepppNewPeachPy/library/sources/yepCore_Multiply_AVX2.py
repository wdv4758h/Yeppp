...
with Function("yepCore_Multiply_V16sV16s_V16s",
        ...
        int64_t, target=uarch.default + isa.avx2) as Multiply_V16sV16s_V16s:
    multiply_generic(arg_x, arg_y, arg_z, arg_n)

yepCore_Multiply_V16sV16s_V16s_AVX2 = Multiply_V16sV16s_V16s.finalize(peachpy.x86_64.abi.detect()).encode()
...
yepCore_Multiply_V16sV16s_V32s_AVX2 = Multiply_V16sV16s_V32s.finalize(peachpy.x86_64.abi.detect()).encode()
...
yepCore_Multiply_V16uV16u_V32u_AVX2 = Multiply_V16uV16u_V32u.finalize(peachpy.x86_64.abi.detect()).encode()
...
with Function("yepCore_Multiply_V32sV32s_V32s",
        (arg_x, arg_y, arg_z, arg_n),
        int64_t, target=uarch.default + isa.avx2) as Multiply_V32sV32s_V32s:
    multiply_generic(arg_x, arg_y, arg_z, arg_n)

yepCore_Multiply_V32sV32s_V32s_AVX2 = Multiply_V32sV32s_V32s.finalize(peachpy.x86_64.abi.detect()).encode()
...
yepCore_Multiply_V32sV32s_V64s_AVX2 = Multiply_V32sV32s_V64s.finalize(peachpy.x86_64.abi.detect()).encode()
...
yepCore_Multiply_V32uV32u_V64u_AVX2 = Multiply_V32uV32u_V64u.finalize(peachpy.x86_64.abi.detect()).encode()
