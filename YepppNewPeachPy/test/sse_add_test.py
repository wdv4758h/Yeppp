...
class TestAddIntegers(unittest2.TestCase):
    ...
    def test_add_V8sV8s_V8s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V8sV8s_V8s.load()
    ...
    def test_add_V8sV8s_V16s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V8sV8s_V16s.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
    ...
    def test_add_V8uV8u_V16u(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V8uV8u_V16u.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
    ...
    def test_add_V16sV16s_V32s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V16sV16s_V32s.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
    ...
    def test_add_V32sV32s_V32s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V32sV32s_V32s.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
    ...
    def test_add_V32sV32s_V64s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V32sV32s_V64s.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
    ...
    def test_add_V64sV64s_V64s(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V64sV64s_V64s.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
...
class TestAddFloats(unittest2.TestCase):
    ...
    def test_add_V32fV32f_V32f(self):
        ...
        func = sse.add.yepCore_Add.yepCore_Add_V32fV32f_V32f.load()
        self.assertEqual(func(a_ptr, b_ptr, c_ptr, self.n), 0)
