...
class TestAddIntegers(unittest2.TestCase):
    ...
    def test_add_V8sV8s_V8s(self):
        ...
        yepCore_Add_V8sV8s_V8s(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V8sV8s_V16s(self):
        ...
        yepCore_Add_V8sV8s_V16s(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V16sV16s_V32s(self):
        ...
        yepCore_Add_V16sV16s_V32s(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V32sV32s_V32s(self):
        ...
        yepCore_Add_V32sV32s_V32s(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V32sV32s_V64s(self):
        ...
        yepCore_Add_V32sV32s_V64s(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V64sV64s_V64s(self):
        ...
        yepCore_Add_V64sV64s_V64s(a_ptr, b_ptr, c_ptr, self.n)
...
class TestAddFloats(unittest2.TestCase):
    ...
    def test_add_V32fV32f_V32f(self):
        ...
        yepCore_Add_V32fV32f_V32f(a_ptr, b_ptr, c_ptr, self.n)
    ...
    def test_add_V64fV64f_V64f(self):
        ...
        yepCore_Add_V64fV64f_V64f(a_ptr, b_ptr, c_ptr, self.n)
